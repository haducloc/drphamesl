...
<!-- @variables
  page.title=${ctx.esc('account_forgotpwd.page_title')}
  page.keywords=${ctx.esc('account_forgotpwd.page_keywords')}
  page.desc=${ctx.esc('account_forgotpwd.page_desc')}
  __layout=layout
 -->
...
<div class="container my-5 text-center">
  <div class="heading-box mb-0">
    ...
    <h1 class="font-sl10 font-w5">${ctx.escCt('account_forgotpwd.title_head')}</h1>
  </div>
</div>
  ...
  <div class="row">
    <div class="col">
      ...
      <div class="mb-4 p-4 shadow-sm">
        <p>${ctx.escCt('account_forgotpwd.resetpwd_text')}</p>

        <t:form id="form1" action="forgotpwd" autocomplete="off">
