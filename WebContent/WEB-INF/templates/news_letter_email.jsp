...
<body>
  <div style="margin-bottom: 1.5rem;">${model.message}</div>
  ...
  <p>
    <small>Nếu bạn không còn muốn nhận được bản tin dịch vụ Tiếng anh từ Dr. Pham, vui lòng nhấp vào <a href="${model.unsubscribeUrl}">hủy đăng ký</a>.
    </small>
  </p>
